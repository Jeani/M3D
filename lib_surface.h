...
//Couleurs Rubik's Cube
#define RC_ROUGE  0x00C41E3A
#define RC_VERT   0x00009E60
#define RC_BLEU   0x000051BA
#define RC_ORANGE 0x00FF5800
...
void definirPixel(t_surface *surface, int x, int y, unsigned long pixel);
